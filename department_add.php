...
<!-- User Profile and Logout Button -->
		...
		<center><h2>Add Department</h2></center><br/>
...
<!--Input Group-->
	<form method="POST" action="department_list.php">
  		...
  		<div class="row">
    		...
    		<div class="col">
      			<h5>Department Name:</h5><input type="text" class="form-control" placeholder="Department Name" name="department_name"  required>
    		</div>
  		</div><br/>
  		<br/><br/>
  		<center>
			<button type="reset" class="btn btn-danger" style="font-size: 23px">Reset</button>
			<button type="submit" class="btn btn-info" name="submit" style="font-size: 23px" onclick="myFunction()">Save</button>
		</center>
	</form>
