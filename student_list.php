...
<!-- Table List -->
		...
		<?php $results = mysqli_query($db, "SELECT * FROM student WHERE student.course_code = student.course_code"); ?>
			...
			<tbody>
				...
				<td><a class="fa fa-edit" href="student_update.php?edit=<?php echo $row['id_number']; ?>"> Edit</a></td>
				</tr>
			</tbody>
			 <?php } ?>
			</table><br/>
			<a href = "student_add.php"><button type="button" class="btn btn-info fa fa-user-plus" style="font-size: 23px; margin-left:935px"> Add Student</button></a></li>
		</div>	
