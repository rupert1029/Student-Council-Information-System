...
<!-- Table List -->
    ...
    <?php $results = mysqli_query($db, "SELECT * FROM program,department WHERE program.department_code = department.department_code"); ?>
      ...
      <tbody>
        ...
        <td><a class="fa fa-edit" href="program_update.php?edit2=<?php echo $row['course_code']; ?>"> Edit</a> | <a class="fa fa-trash" href ="#" data-toggle="modal" data-target="#exampleModal"> Delete</a></td>
        </tr>
      </tbody>
       <?php } 
       ?>
      </table><br/>
      <a href = "program_add.php"><button type="button" class="btn btn-info fa fa-plus" style="font-size: 23px; margin-left:935px"> Add Program</button></a></li>
    </div>  
