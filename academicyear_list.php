...
<!-- Table List -->
		...
		<center><h2>Academic Year List</h2></center>
		<?php $results = mysqli_query($db, "SELECT * FROM academic_year WHERE academic_year.academic_code = academic_year.academic_code"); ?>
			<table class="table table-secondary" style="margin-top:20px">
			<thead class="thead-light">
				<tr class="success">
				<th scope="col">Academic Year Code</th>	
			...
			<tbody>
				...
				<td><a class="fa fa-edit" href="academicyear_update.php?edit6=<?php echo $row['academic_code']; ?>"> Edit</a> | <a class="fa fa-trash" href ="#" data-toggle="modal" data-target="#exampleModal"> Delete</a></td>
				</tr>
			</tbody>
			 <?php } ?>
			</table><br/>
			<a href = "academicyear_add.php"><button type="button" class="btn btn-info fa fa-plus" style="font-size: 23px; margin-left:935px"> Add Academic Year</button></a></li>
		</div>	
