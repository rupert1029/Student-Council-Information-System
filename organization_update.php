...
<!--Input Group-->
	<form method="POST" action="organization_list.php">
  		<div class="row">
    		<div class="col">
     	 		<input type="text" class="form-control" value="<?php echo $organization_code; ?>" name="organization_code" required>
    		</div>
    		<div class="col">
  		...
  		<center>
			<?php if ($update == true): ?>
					<button type="submit" class="btn btn-info" name="update5" style="font-size: 23px">Update</button>
       		<?php else: ?>
