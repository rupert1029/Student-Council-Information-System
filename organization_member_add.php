...
<!-- User Profile and Logout Button -->
		...
		<center><h2>Add Organization Member</h2></center><br/>

<!--Input Group-->
	<form method="POST" action="organization_member_list.php">
    	...
    	<div class="row">
         ...
         <h5>Organization Name:</h5><select name = "organization_code" class="form-control">
  		...
  		<center>
			...
			<button type="submit" class="btn btn-info" name="sige" style="font-size: 23px" onclick="myFunction()">Save</button>
		</center>
	</form>
