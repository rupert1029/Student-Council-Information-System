...
<!-- Table List -->
    ...
    <center><h2>Event List</h2></center>
    <?php $results = mysqli_query($db, "SELECT * FROM event WHERE event.event_code = event.event_code"); ?>
      ...
      <tbody>
        ...
        <td><a class="fa fa-edit" href="event_update.php?edit7=<?php echo $row['event_code']; ?>"> Edit</a> | <a class="fa fa-trash" href ="#" data-toggle="modal" data-target="#exampleModal"> Delete</a></td>
        </tr>
      </tbody>
       <?php } 
       ?>
      </table><br/>
      <a href = "event_add.php"><button type="button" class="btn btn-info fa fa-plus" style="font-size: 23px; margin-left:935px"> Add Event</button></a></li>
    </div>  
