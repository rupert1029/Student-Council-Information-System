...
<!-- Table List -->
		...
		<center><h2>Organization Officer List</h2></center>
		<?php $results = mysqli_query($db, "SELECT * FROM organization_officer,student,academic_year,organization WHERE organization_officer.id_number=student.id_number AND organization_officer.academic_code=academic_year.academic_code AND organization_officer.organization_code=organization.organization_code"); ?>
			...
			<a href = "organization_officer_add.php"><button type="button" class="btn btn-info fa fa-plus" style="font-size: 23px; margin-left:935px"> Add Organization Officer</button></a></li>
		</div>	
